...
1. `docs/prompts/SESSION_PREAMBLE.md`
2. `docs/instructions/PM_OPERATING_RULES.md`
3. `docs/briefs/PM_HANDOFF_GEN32_HARD_FAIL_2026-07-29.md` ← ground truth, failure matrix, constraints
4. `docs/plans/GRAND_PLAN.md` §6 (window model) and `docs/plans/STAGE2_CLOSEOUT_WORK_ORDER.md`
5. `docs/reports/stage2-runtime-gate.md` (the gate that was stopped)
6. `docs/reports/EXECUTION_LOG.md` (tail)
